# 🏦Bank Widget
## Описание:
Проект для обработки банковских транзакций с поддержкой:
- Чтения из CSV/Excel
- Маскировки данных
...
```
pip install pandas==2.0.3 openpyxl==3.1.2 pyyaml==6.0.1
pip install pytest==7.4.0 pytest-mock==3.11.1 pytest-cov==4.1.0 mypy==1.5.1 flake8==6.0.0 isort==5.12.0
```
## Использование:
...
Теперь проект поддерживает чтение транзакций из файлов разных форматов:
